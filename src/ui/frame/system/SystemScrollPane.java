...
public class SystemScrollPane extends JScrollPane  implements ActionListener{
	...
	public SystemScrollPane(){
		...
		this.setViewportView(systemPanel);
		
		button = new JButton();
		button.setBounds((int) (1720 * UIData.changeX), y, (int) (200 * UIData.changeX), systemPanel.height);
