...
public class MatchBounds {
	...
	public static int MatchSizeY = 600;
	...
	//searchButton的bounds
	public static int searchButtonX = TeamComboBoxX + TeamComboBoxSizeX + 20;
	...
	public static int scrollPaneSizeY = MatchSizeY - scrollPaneY;
